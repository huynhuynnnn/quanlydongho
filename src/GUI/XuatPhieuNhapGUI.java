...
public class XuatPhieuNhapGUI extends javax.swing.JDialog {
    ...
    public XuatPhieuNhapGUI(String nhaCungCap, String nhanVien, ArrayList<CTPhieuNhap> listCTPhieuNhap, float loiNhuan, int donGiaData) {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        for (CTPhieuNhap ctpn : listCTPhieuNhap) {
            ...
            //===================================================
            ctpn.setMaPN(maPN);
            ctPhieuNhapBUS.luuCTPhieuNhap(ctpn, loiNhuan, donGiaData);
        }
