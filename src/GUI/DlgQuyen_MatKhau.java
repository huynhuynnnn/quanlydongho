...
public class DlgQuyen_MatKhau extends javax.swing.JDialog {
    ...
    public String quyenSelected(){
        return (String) cmbQuyen.getSelectedItem();
    }
    ...
    private void initComponents() {
        ...
        btnCapMatKhau.setBackground(new java.awt.Color(204, 255, 255));
        ...
        btnLuuQuyen.setBackground(new java.awt.Color(204, 255, 255));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnTab, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE))
        );
