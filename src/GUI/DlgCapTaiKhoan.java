...
public class DlgCapTaiKhoan extends javax.swing.JDialog {
    ...
    private String maNV,quyen;

    public DlgCapTaiKhoan(String maNV,String quyen) {
        this.maNV = maNV;
        this.quyen = quyen ;
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbQuyen = new javax.swing.JTextField();
