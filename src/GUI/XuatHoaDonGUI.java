...
public class XuatHoaDonGUI extends JDialog {
    ...
    private void initComponents() {
        ...
        btnTimMaGiam.setBackground(new java.awt.Color(204, 255, 255));
        btnTimMaGiam.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnTimMaGiam.setText("Select");
        ...
        btnTimKhach.setBackground(new java.awt.Color(204, 255, 255));
        btnTimKhach.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnTimKhach.setText("Select");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtTenKhach, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE)
                    .addComponent(txtMaGiam)
                    .addComponent(txtTongTien))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 68, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnTimKhach, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
                    .addComponent(btnTimMaGiam, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(20, 20, 20))
    ...
    private void btnTimMaGiamActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (timMaUI.maGiamTimDuoc != null) {
            txtMaGiam.setText(timMaUI.maGiamTimDuoc.getMaGG() + " - " + timMaUI.maGiamTimDuoc.getTenGG());
        }
    }
